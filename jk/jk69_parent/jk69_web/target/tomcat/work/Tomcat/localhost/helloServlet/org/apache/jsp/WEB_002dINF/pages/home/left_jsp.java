 ...
 * Generated at: 2017-11-21 03:51:52 UTC
...
public final class left_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    \t\t\t$(fastMenu).html('');\r\n");
      out.write("    \t\t\tvar url = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/menuAction_getFastMenuJson\";\r\n");
      out.write("        \t\t$.post(url,null,function(data) {\r\n");
      out.write("        \t\t\t$(data).each(function(i,n) {\r\n");
      out.write("        \t\t\t\tvar li = \"<li><a href='");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/\" + n.curl + \"' onclick='linkHighlighted(this)' style='font-size:14px;' target='main' id='aa_1'>\" + n.moduleName + \"</a></li>\";\r\n");
      out.write("    \t\t\t\t\t$(fastMenu).prepend(li); \r\n");
      out.write("        \t\t\t});\r\n");
      out.write("        \t\t},\"json\");\r\n");
      out.write("\t\t\t\tvar clear = \"<a href='#' onclick='delFastMenu()' class='DelFastMenu'><font color='gray'>清除常用功能列表</font></a>\"\r\n");
      out.write("\t\t\t\t$(fastMenu).prepend(clear); \r\n");
      out.write("        \t\t\r\n");
      out.write("    \t\t\t$(fastMenu).show();\r\n");
      out.write("    \t\t\t$(customerMenu).hide();\r\n");
      out.write("    \t\t}else if(who==\"customerMenu\"){\r\n");
      out.write("    \t\t\t$(customerMenu).html('');\r\n");
      out.write("\t\t\t\tvar clear = \"<a href='");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/menuAction_toCustom' class='DelFastMenu' target='main'><font color='gray'>自定义模块列表</font></a>\"\r\n");
      out.write("\t\t\t\t$(customerMenu).prepend(clear); \r\n");
      out.write("    \t\t\tvar url = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/menuAction_getCustomMenuJson\";\r\n");
      out.write("        \t\t$.post(url,null,function(data) {\r\n");
      out.write("        \t\t\t$(data).each(function(i,n) {\r\n");
      out.write("        \t\t\t\tvar li = \"<li><a href='");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/\" + n.curl + \"' onclick='linkHighlighted(this)' style='font-size:14px;' target='main' id='aa_1'>\" + n.moduleName + \"</a></li>\";\r\n");
      out.write("    \t\t\t\t\t$(customerMenu).prepend(li); \r\n");
      out.write("        \t\t\t});\r\n");
      out.write("        \t\t},\"json\");\r\n");
      out.write("    \t\t\t\r\n");
      ...
      out.write("    \t\t}\r\n");
      out.write("    \t}\r\n");
      out.write("    \tfunction delFastMenu(){\r\n");
      out.write("    \t\tvar url = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/menuAction_clearFastMenuJson\";\r\n");
      out.write("    \t\t$.get(url);\r\n");
      out.write("    \t\t$(fastMenu).html('');\r\n");
      ...
      out.write("\t\t\t\t\t<li><a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/homeAction_tomain.action?moduleName=home\"  target=\"main\" id=\"aa_3\" onclick=\"linkHighlighted(this)\">我的备忘录</a></li>\r\n");
      out.write("\t\t\t\t\t<li><a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/befor/taskAction_list\" target=\"main\" id=\"aa_2\" onclick=\"linkHighlighted(this)\">我的代办任务</a></li>\r\n");
      out.write("\t\t\t\t\t<li><a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/befor/opinionAction_list\" target=\"main\" id=\"aa_1\" onclick=\"linkHighlighted(this)\">任务反馈</a></li>\r\n");
      out.write("\t\t\t\t</ul>\r\n");
      out.write("\t        </div>\r\n");
      out.write("\t        \r\n");
      out.write("\t       </div>\r\n");
      ...
      out.write("\t         切换:<a href=\"#\" onmouseover=\"javascript:showMenu('fastMenu');\">快捷菜单</a>\r\n");
      out.write("\t        /\r\n");
      out.write("\t        <a href=\"#\" onmouseover=\"javascript:showMenu('customerMenu');\">自定义菜单</a>\r\n");
      out.write("\t        </div>\r\n");
      ...
      out.write("\t\t\t\t<li><a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sysadmin/userInfoAction_list\" target=\"main\" id=\"aa_2\" onclick=\"linkHighlighted(this)\">个人信息修改</a></li>\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t<li><a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sysback/sysbackAction_tosysbackview\" target=\"main\" id=\"aa_2\" onclick=\"linkHighlighted(this)\">系统使用反馈</a></li>\t\t\t\t\t\r\n");
      out.write("\t\t\t</ul>\r\n");
      out.write("        </div>\r\n");
      out.write("    </div>\r\n");
      out.write("    </div>\r\n");
