...
function msgupdate(id){
    ...
    inputElement.onblur = function() {  
        ...
        $.get(url);
        /* window.self.location = "${ctx }/homeAction_updateBBS?content=" + content + "&left=" + left + "&top=" + top + "&id=" + id;  */
    }  
	/* Submit("/home/olmsgUpdateAction.do?flag="+flag+"&id="+id,null,"修改");
	document.myForm.submit(); */
}
 
function msgdel( id ){
	if(confirm("是否确定要删除此条信息?")){
		var url = "${ctx }/homeAction_removeBBS?id=" + id;
...
<logic:notEmpty name="olmsgList">
  <c:forEach items="${userBBSList}" var="o">
		<div id='${o.id}' style='position:absolute;left:${o.left}px;top:${o.top}px;z-index:1001; height:164px;background:none;' onmousedown='getFocus(this)'>
			<table border=0 cellspacing="0" cellpadding="0" width="220">
				<tr>
					<td style='cursor:move;' background="${ctx}/images/olmsg/${o.backGround1}" height="45">
